...
import {
  ...
  Activity, ArrowUpRight, ArrowDownRight, Star,
  ThumbsUp, Download
} from "lucide-react";
    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">Track sermon effectiveness and congregation response</p>
        </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="overview" className="data-[state=active]:text-white">Overview</TabsTrigger>
          <TabsTrigger value="sermons" className="data-[state=active]:text-white">Sermon Performance</TabsTrigger>
          <TabsTrigger value="feedback" className="data-[state=active]:text-white">Feedback Analysis</TabsTrigger>
          <TabsTrigger value="trends" className="data-[state=active]:text-white">Engagement Trends</TabsTrigger>
        </TabsList>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">New sermon feedback received</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">12 new prayer requests submitted</span>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm text-gray-700 dark:text-gray-300">Content shared 47 times on social media</span>
                  </div>
