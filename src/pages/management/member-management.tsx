      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">
            ...
            Contact your community administrator to request member management access.
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Manage community members, roles, and permissions across your communities
          </p>
        </div>
      </div>
      ...
      {!effectiveCommunityId && adminCommunities.length > 1 && (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-gray-600">
              Choose a community from the dropdown above to manage its members and roles.
            </p>
          </CardContent>
        </Card>
      )}
